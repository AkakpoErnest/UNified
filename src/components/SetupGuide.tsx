    ...
    <div className="bg-gradient-to-br from-blue-500/10 via-indigo-500/10 to-blue-600/10 border border-blue-400/20 rounded-2xl p-6 backdrop-blur-2xl shadow-xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-blue-200/70">Follow these steps to experience seamless Web3 transactions</p>
        </div>
      </div>
        ...
        <div className="bg-white/5 rounded-xl p-4 border border-blue-400/20">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={network.name} className="flex items-center justify-between bg-white/5 rounded-lg p-3 border border-blue-400/20">
                <div>
                  <div className="text-white font-medium text-sm">{network.name}</div>
                  <div className="text-blue-200/70 text-xs">Chain ID: {network.chainId}</div>
                </div>
                <button
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border border-blue-400/30 rounded-xl">
